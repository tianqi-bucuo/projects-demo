package com.cky.clusterDemo.init;
...
import com.cky.clusterDemo.DemoConstants;
import com.cky.clusterDemo.entity.ClusterGroupEntity;

public class DemoClusterInitFunc implements InitFunc {

    private static final String APP_NAME = "appB";
    ...
    public static void main(String[] args) throws Exception {
        DemoClusterInitFunc initFunc = new DemoClusterInitFunc();
        initFunc.init();
    }
}
